   //example of object from video
    ...
    console.log(flower.stem);
    console.log(flower.petals);
    console.log(flower.petalColor);

    
    //settings for model to import
    //new mesh I've created and scaled
      let model_settings = {
          folder: "https://models.babylonjs.com/", 
          file: "PBR_Spheres.glb",
          color: {r:1, g:0, b:0},
          scale: 3,
